...
export default function WhySolarCommandPage() {
  return (
    <div>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="rounded-xl bg-white p-6 text-center shadow-sm border border-gray-200">
              ...
              <h3 className="mt-4 text-xl font-semibold text-amber-600">Premium Products</h3>
            ...
            <div className="rounded-xl bg-white p-6 text-center shadow-sm border border-gray-200">
              ...
              <h3 className="mt-4 text-xl font-semibold text-amber-600">Certified Installation</h3>
              <p className="mt-2 text-base text-solar-700 leading-relaxed">
            ...
            <div className="rounded-xl bg-white p-6 text-center shadow-sm border border-gray-200">
              ...
              <h3 className="mt-4 text-xl font-semibold text-amber-600">Attention to Detail</h3>
              <p className="mt-2 text-base text-solar-700 leading-relaxed">
            ...
            <div className="rounded-xl bg-white p-6 text-center shadow-sm border border-gray-200">
              ...
              <h3 className="mt-4 text-xl font-semibold text-amber-600">Expert Advice</h3>
              <p className="mt-2 text-base text-solar-700 leading-relaxed">
            ...
            <div className="rounded-xl bg-white p-6 text-center shadow-sm border border-gray-200">
              ...
              <h3 className="mt-4 text-xl font-semibold text-amber-600">Hassle-Free Pricing</h3>
              <p className="mt-2 text-base text-solar-700 leading-relaxed">
            ...
            <div className="rounded-xl bg-white p-6 text-center shadow-sm border border-gray-200">
              ...
              <h3 className="mt-4 text-xl font-semibold text-amber-600">Flexible Payment</h3>
              <p className="mt-2 text-base text-solar-700 leading-relaxed">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          ...
          <div className="mt-10 overflow-hidden rounded-xl bg-white shadow-sm border border-gray-200">
            ...
            <div className="grid grid-cols-3 bg-gray-50 border-b border-gray-200">
              <div className="px-5 py-4 text-base font-semibold text-gray-700">Coverage</div>
              <div className="px-5 py-4 text-center text-base font-semibold text-solar-700 bg-solar-50">
                Sunburst Solar (25 Years)
              </div>
              <div className="px-5 py-4 text-center text-base font-semibold text-solar-700">
            ...
            <div className="grid grid-cols-3 border-b border-gray-100">
              <div className="px-5 py-3.5 text-base text-gray-700">Complete System Coverage</div>
            ...
            <div className="grid grid-cols-3 border-b border-gray-100">
              <div className="px-5 py-3.5 text-base text-gray-700">Defective Part Removal</div>
              <div className="px-5 py-3.5 text-center bg-solar-50/40">
                <svg width={20} height={20} className="mx-auto h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
            ...
            <div className="grid grid-cols-3 border-b border-gray-100">
              <div className="px-5 py-3.5 text-base text-gray-700">New Part Installation</div>
              <div className="px-5 py-3.5 text-center bg-solar-50/40">
                <svg width={20} height={20} className="mx-auto h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
            ...
            <div className="grid grid-cols-3 border-b border-gray-100">
              <div className="px-5 py-3.5 text-base text-gray-700">Shipping Included</div>
              <div className="px-5 py-3.5 text-center bg-solar-50/40">
                <svg width={20} height={20} className="mx-auto h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
            ...
            <div className="grid grid-cols-3 border-b border-gray-100">
              <div className="px-5 py-3.5 text-base text-gray-700">25-Year Production Guarantee</div>
              <div className="px-5 py-3.5 text-center bg-solar-50/40">
                <svg width={20} height={20} className="mx-auto h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
            ...
            <div className="grid grid-cols-3">
              <div className="px-5 py-3.5 text-base text-gray-700">Performance Monitoring</div>
              <div className="px-5 py-3.5 text-center bg-solar-50/40">
                <svg width={20} height={20} className="mx-auto h-5 w-5 text-green-500" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                </svg>
              </div>
              <div className="px-5 py-3.5 text-center text-base text-gray-400 font-medium">
                Limited
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <h2 className="text-center text-4xl font-bold text-amber-600">Our Services</h2>
          <p className="mt-2 text-center text-solar-700">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2">
            ...
            <div className="flex gap-4 rounded-xl bg-white p-6 shadow-sm border border-gray-200">
              ...
              <div>
                <h3 className="text-lg font-semibold text-amber-600">Solar Panel Installation</h3>
                <p className="mt-1 text-base text-solar-700 leading-relaxed">
            ...
            <div className="flex gap-4 rounded-xl bg-white p-6 shadow-sm border border-gray-200">
              ...
              <div>
                <h3 className="text-lg font-semibold text-amber-600">Enphase Battery Backup</h3>
                <p className="mt-1 text-base text-solar-700 leading-relaxed">
            ...
            <div className="flex gap-4 rounded-xl bg-white p-6 shadow-sm border border-gray-200">
              ...
              <div>
                <h3 className="text-lg font-semibold text-amber-600">Solar Panel Cleaning</h3>
                <p className="mt-1 text-base text-solar-700 leading-relaxed">
            ...
            <div className="flex gap-4 rounded-xl bg-white p-6 shadow-sm border border-gray-200">
              ...
              <div>
                <h3 className="text-lg font-semibold text-amber-600">Electricity Bill Audit</h3>
                <p className="mt-1 text-base text-solar-700 leading-relaxed">
      ...
      <section className="bg-white border-t border-gray-100 py-16 sm:py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          ...
          <p className="mt-2 text-center text-xl text-solar-600 font-medium">
          ...
          <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex gap-4 rounded-xl bg-white p-5 shadow-sm border border-gray-200">
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-solar-600 text-base font-bold text-white">
                1
              </div>
              <div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-3xl px-4 sm:px-6">
          <div className="rounded-xl bg-white p-8 text-center shadow-sm border border-gray-200 sm:p-10">
            ...
            <h2 className="mt-5 text-3xl font-bold text-amber-600 sm:text-4xl">
              Licensed &amp; Insured
            </h2>
            <p className="mt-3 text-xl font-semibold text-solar-600">
            ...
            <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-gray-50 border border-gray-200 px-5 py-2.5">
              ...
              <span className="text-base text-solar-700">
